...
class ReverseIndex {
    static deserialize(buffer, deserialize, optimize, config) {
        ...
        const view = data_view_js_1.StaticDataView.fromUint8Array(buffer.getBytes(true /* align */), config);
    ...
    constructor({ deserialize, filters, optimize, config, }) {
        ...
        this.cache = new Map();
        this.view = data_view_js_1.StaticDataView.empty(config);
    ...
    update(newFilters, removedFilters) {
        ...
        if (filters.length === 0) {
            this.updateInternals({
                ...
                view: data_view_js_1.StaticDataView.empty(this.config),
            });
            return;
        }
        ...
        const buffer = data_view_js_1.StaticDataView.allocate(estimatedBufferSize, this.config);
