...
class Domains {
    static parse(parts, debug = false) {
        ...
        for (let hostname of parts) {
            ...
            const hash = (0, request_js_1.hashHostnameBackward)(negation === true || entity === true ? hostname.slice(start, end) : hostname);
            if (negation) {
                if (entity) {
    ...
    updateId(hash) {
        ...
        if (hostnames !== undefined) {
            for (const hostname of hostnames) {
                hash = (hash * utils_js_1.HASH_INTERNAL_MULT) ^ hostname;
            }
        }
        if (entities !== undefined) {
            for (const entity of entities) {
                hash = (hash * utils_js_1.HASH_INTERNAL_MULT) ^ entity;
            }
        }
        if (notHostnames !== undefined) {
            for (const notHostname of notHostnames) {
                hash = (hash * utils_js_1.HASH_INTERNAL_MULT) ^ notHostname;
            }
        }
        if (notEntities !== undefined) {
            for (const notEntity of notEntities) {
                hash = (hash * utils_js_1.HASH_INTERNAL_MULT) ^ notEntity;
            }
        }
        return hash;
    }
    ...
    getSerializedSize() {
        ...
        if (this.entities !== undefined) {
            estimate += (0, data_view_js_1.sizeOfUint32Array)(this.entities);
        }
        if (this.hostnames !== undefined) {
            estimate += (0, data_view_js_1.sizeOfUint32Array)(this.hostnames);
        }
        if (this.notHostnames !== undefined) {
            estimate += (0, data_view_js_1.sizeOfUint32Array)(this.notHostnames);
        }
        if (this.notEntities !== undefined) {
            estimate += (0, data_view_js_1.sizeOfUint32Array)(this.notEntities);
        }
        if (this.parts !== undefined) {
            estimate += (0, data_view_js_1.sizeOfUTF8)(this.parts);
        }
        return estimate;
    }
    match(hostnameHashes, entityHashes) {
        ...
        if (this.notHostnames !== undefined) {
            for (const hash of hostnameHashes) {
                if ((0, utils_js_1.binLookup)(this.notHostnames, hash)) {
                    return false;
                }
            }
        }
        ...
        if (this.notEntities !== undefined) {
            for (const hash of entityHashes) {
                if ((0, utils_js_1.binLookup)(this.notEntities, hash)) {
                    return false;
                }
            }
        }
        ...
        if (this.hostnames !== undefined || this.entities !== undefined) {
            if (this.hostnames !== undefined) {
                for (const hash of hostnameHashes) {
                    if ((0, utils_js_1.binLookup)(this.hostnames, hash)) {
                        return true;
                    }
                }
            }
            if (this.entities !== undefined) {
                for (const hash of entityHashes) {
                    if ((0, utils_js_1.binLookup)(this.entities, hash)) {
                        return true;
                    }
                }
            }
