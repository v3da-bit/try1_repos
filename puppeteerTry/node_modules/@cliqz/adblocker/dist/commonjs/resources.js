...
class Resources {
    ...
    getSerializedSize() {
        let estimatedSize = (0, data_view_js_1.sizeOfASCII)(this.checksum) + 2 * (0, data_view_js_1.sizeOfByte)(); // resources.size
        this.resources.forEach(({ contentType, body }, name) => {
            estimatedSize += (0, data_view_js_1.sizeOfASCII)(name) + (0, data_view_js_1.sizeOfASCII)(contentType) + (0, data_view_js_1.sizeOfUTF8)(body);
        });
